...
/* This function will generate a list of states as a drop down list as hard coded
*/
...
/* This function will generate a list of states as a drop down list from a DB lookup table
*/

function stateOptionListDB()
{  	
	$list = "";
	global $con;  //must use global since it is inside a function definition

	//********
	//NOTE: Database Name is case sensitive on phpMyAdmin for this class
	//********
	$sql = "select StateID, LongName from STATE_DB_TEST";
	$result = $con->query($sql);

	while($row = $result->fetch(PDO::FETCH_ASSOC)) {

		$list = $list. '<option value = "'.$row["StateID"].'">'.$row["LongName"].'</option>';
	}
