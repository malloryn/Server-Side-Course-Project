...
<body>
    ...
    <?php
        if(isset($_POST['submit'])) {
            ...
            if(spamcheck($uname)) { //checking for a valid email format
                ...
                $stmt = $con->prepare("select count(*) as c from CUSTOMER where email = ? and password = ?");
                ...
                if ($count == 1) {
                    $stmt = $con->prepare("Select CustomerID from CUSTOMER where email = ? and password = ?");
                    $stmt->execute(array($uname, $password));
                    $row = $stmt->fetch(PDO::FETCH_OBJ);
    ...
    <div class="form_container">
        ...
        <form action="#" method="post">
            ...
            <!-- send customer to the customer portal -->
            <div class="center">
