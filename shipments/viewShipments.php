...
<body>
    ...
    <!-- end header -->
    <div>
        <h1>Shipments in System</h1>
    </div>
    <div class="center">
        <a href="editShipment.php">Edit</a> 
    </div>
    <div class="center">
        <a href="deleteShipment.php">Delete</a> 
    </div>
    <!-- Add download button -->
    <div class="center">
    ...
    <div class="table-container">
        <?php
            ...
            $stmt = $con->prepare("SELECT * FROM SHIPMENT");
            ...
            if (!empty($rows)) {
                print '<table>';
                print '<tr class="darker_header"><td>Shipment ID</td><td>Customer ID</td><td>Order ID</td><td>Transportation Method</td></tr>';

                foreach ($rows as $row) {
                    print '<tr>';
                    print '<td>'.$row["ShipmentID"]."</td><td>".$row["CustomerID"]."</td><td>".$row["OrderID"]."</td><td>".$row["TransportationMethod"]."</td>";
                    print '</tr>';
                }
                print '</table>';
            }
        ...
        <script>
            ...
            document.getElementById('download-csv').addEventListener('click', function () {
                ...
                downloadLink.download = 'shipment_data.csv';
