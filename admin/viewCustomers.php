...
<body>
    ...
    <div class="table-container">
        <?php
            ...
            $stmt = $con->prepare("SELECT CustomerID, FirstName, LastName, Email, Address, Phone FROM CUSTOMER");
            ...
            if (!empty($rows)) {
                print '<table>';
                print '<tr class="darker_header"><td>Customer ID</td><td>First Name</td><td>Last Name</td><td>Email</td><td>Address</td><td>Phone Number</td></tr>';

                foreach ($rows as $row) {
                    print '<tr>';
                    print '<td>'.$row["CustomerID"]."</td><td>".$row["FirstName"]."</td><td>".$row["LastName"]."</td><td>".$row["Email"]."</td><td>".$row["Address"]."</td><td>".$row["Phone"]."</td>";
                    print '</tr>';
                }
                print '</table>';
            }
